    ...
    for _ in range(1_000_000):
        ...
        for i in range(num_stars):
            if planets[i][0] != 0.0:
                ...
                if 0.1 < astrom_signal/sigma_fov < 100.0 and planets[i][1]/365.25 < 9.5 and get_acceptance_bool(astrom_signal/sigma_fov):
                    ...
                    with open("data/chi2_vs_SNR_DR5/file" + str(run_num) + "_" + str(recorded_count) + ".pkl", "wb") as f:
