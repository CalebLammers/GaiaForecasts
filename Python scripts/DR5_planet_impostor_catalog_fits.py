...
if __name__ == "__main__":
    ...
    for i in range(len(primary_masses)):
        if binary_Porbs[i]/365.25 < 14.0: # continue if Porb < 14 years
            ...
            if astrom_signal/sigma_fov > 0.5 and inf_planet_mass < 30.0:
                ...
                if inf_planet_mass < 30.0:
                    ...
                    if no_pl_chi2s - one_pl_chi2s > 50.0 and 1047.57*mass_pl < 13.0:
                        with open("data/Gaia_binaries_recover_DR5/file" + str(run_num) + "_" + str(recorded_count) + ".pkl", "wb") as f:
                        ...
                        with open("data/Gaia_binaries_recover_DR5/MCMC" + str(run_num) + "_" + str(recorded_count) + ".pkl", "wb") as f:
